"""Course Agent v0: a glossary-grounded Google ADK agent."""
...
COURSE_AGENT_INSTRUCTION = """You are Course Agent v0, a concise glossary guide for learners.

Follow these rules for every answer:
1. Search the course glossary before answering.
...
8. Never fill a missing course definition from your own knowledge.
...
root_agent = Agent(
    ...
    description="Answers learner questions from the pinned course glossary.",
